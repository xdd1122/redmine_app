...
module RedmineContacts
  module TestHelper
    ...
    def with_redmineup_settings(options, &block)
      original_settings = Setting.plugin_redmineup
      Setting.plugin_redmineup = original_settings.merge(Hash[options.map {|k,v| [k, v]}])
      yield
    ensure
      Setting.plugin_redmineup = original_settings
    end
  end
end
